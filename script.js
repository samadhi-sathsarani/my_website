...
function showSection(sectionName) {
    ...
    main.innerHTML = `
        <section class="section-container form-box" style="text-align:center;">
            ...
            <p style="margin-top:20px;">Don't have an account? <a href="#" onclick="showSection('signup')" style="text-decoration:underline;">Sign Up</a></p>
        </section>
    `;
    ...
    main.innerHTML = `
        <section class="section-container form-box" style="text-align:center;">
            ...
            <p style="margin-top:20px;">
                ...
                <a href="#" onclick="showSection('login')" style="text-decoration:underline;">
                    Sign In
                </a>
            </p>
        </section>
...
async function handleLogin() {
    ...
    try {
        ...
        if (result.status === "success") {
            ...
            renderHome(); // Redirect to home after login
        } else {
            alert(result.message); // Shows "Wrong password" etc.
        }
    } catch (error) {
